...
run.font.name='나눔고딕'
run._element.rPr.fFonts.set(qn('w:eastAsia'), '나눔고딕')
...
run.font.name='나눔고딕'
run._element.rPr.rFonts.set(qn('w:eastAsia', '나눔고딕'))
run.fonts.size=docx.shared.Pt(20)
run=para.add_run('교 육 과 정: 2023.12.09-2023.12.09\n')
run.font.name='나눔고딕'
run._element.rPr.rFonts.set(qn('w:eastAsia', '나눔고딕'))
run.fonts.size=docx.shared.Pt(20)
